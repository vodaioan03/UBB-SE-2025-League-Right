...
namespace Duo.Views.Components.Modals
{
    public sealed partial class CreateQuizModal : UserControl
    {
        ...
        private async void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            var quiz = new Quiz<Exercise>(new Random().Next(1000)); // Using random ID for demo
    ...
    {
        public Quiz<Exercise> Quiz { get; }
        public string Title { get; }

        public QuizCreatedEventArgs(Quiz<Exercise> quiz, string title)
        {
            Quiz = quiz;
            Title = title;
        }
